...
document.addEventListener('DOMContentLoaded', function() {
  ...
  paginationLinks.forEach(link => {
    link.addEventListener('click', function(e) {
      ...
      // Determine if we're in upcoming or past tab
      const isUpcoming = targetPageId.includes('upcoming');
      
      // Get all pages of the current tab
      const pages = document.querySelectorAll(isUpcoming ? '.concerts-upcoming-page' : '.concerts-past-page');
      ...
      const paginationSet = document.querySelectorAll(isUpcoming ? '#concerts-upcoming .pagination-page' : '#concerts-past .pagination-page');
      paginationSet.forEach(p => {
